...
public class HarmonicSum {   // Save as "HarmonicSum.java"
   public static void main (String[] args) {
     ...
     for (int denominator = MAX_DENOMINATOR ; 1 <= denominator; --denominator) {
      ...
      if (sumL2R > sumR2L) System.out.println("Les deux sommes sont différentes") ;
      else System.out.println("C'est good !") ;
   }
}